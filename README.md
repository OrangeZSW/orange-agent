...
- 🔍 **智能代码搜索**：支持代码库快速检索，定位功能实现和代码片段，自动构建代码索引
...
- `api_tester` - API 接口测试
- `skill` - 获取技能详细信息
- `code_search` - 搜索项目代码库，检索相关代码片段
- `code_index_init` - 初始化或刷新代码索引，支持全量/增量更新
...
- ✨ **新增智能代码搜索功能**：支持代码库快速检索，定位功能实现和代码片段
- ⚡ **新增代码索引工具**：支持全量/增量构建代码索引，提升搜索效率
- 📚 **完善文档**：补充代码搜索相关功能说明和工具使用介绍
- 🐛 **问题修复**：优化工具调用参数校验，提升系统稳定性
